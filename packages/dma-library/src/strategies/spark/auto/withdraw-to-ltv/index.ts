...
export type SparkWithdrawDependencies = Omit<
...
export type SparkWithdrawToLTV = (
  args: SparkWithdrawArgs,
  dependencies: SparkWithdrawDependencies,
) => Promise<WithdrawToLTVStrategy>

export const withdraw: SparkWithdrawToLTV = async (args, dependencies) => {
