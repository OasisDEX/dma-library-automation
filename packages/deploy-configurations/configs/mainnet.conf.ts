  ...
  mpa: {
    ...
    actions: {
      ...
      SwapAction: {
        name: 'SwapAction',
        deploy: false,
        address: '0xdb8C4Faa8643cE4C3f8c9A9Cc0Fc70645A6e449c',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.common.SWAP_ACTION,
        history: [
          '0x76064cCF2EF1E98Cc60Ddd512E0A8B794d61FAB5',
      ...
      TakeFlashloan: {
        ...
        history: [
          '0xdF2cc941f0D856121cf2e25DACBE55e349f3f6Bc',
      ...
      TakeFlashloanBalancer: {
        ...
        deploy: false,
        address: '0xfE5eDCaCC91561ddEE37464BC3670A281E1D9fBC',
      ...
      SetApproval: {
        name: 'SetApproval',
        deploy: false,
        address: '0xb34356236f894d289D74a2d352AbF119f81393c0',
      ...
      PullToken: {
        name: 'PullToken',
        deploy: false,
        address: '0xfCf0E27322076566436Ad086c087C28E31575f95',
      ...
      SendToken: {
        name: 'SendToken',
        deploy: false,
        address: '0x10943e7094f0b10469ec7019F7aC1910703e85c8',
      ...
      SendTokenAuto: {
        name: 'SendTokenAuto',
        deploy: false,
        address: '0xCD4E7711716cC02209c4035b702dB3fEbb20780d',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.common.SEND_TOKEN_AUTO,
        history: [
          '0xCD4E7711716cC02209c4035b702dB3fEbb20780d',
          '0xCD4E7711716cC02209c4035b702dB3fEbb20780d'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      WrapEth: {
        name: 'WrapEth',
        deploy: false,
        address: '0x8249AA04691F8D5000B4218Ed8bD019c81Ff6E93',
        ...
        history: [
          ...
          '0x8A78E3C115398D7f727670cD9cB23780cc87ac8c'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      UnwrapEth: {
        name: 'UnwrapEth',
        deploy: false,
        address: '0x5ddCe95A385EdF3B26214Bd89Cf84eC5BdF503fB',
      ...
      ReturnFunds: {
        name: 'ReturnFunds',
        deploy: false,
        address: '0xe70C40d0cbbB4058aFB2E1A4Cf8F4CaE0ea6E60c',
        ...
        history: [
          ...
          '0xb6E6e38ad9840b7ACAB968abBED5eEf7289BfB19'
        ],
        constructorArgs: []
      },
      CollectFee: {
      ...
      AaveV3Borrow: {
        name: 'AaveV3Borrow',
        deploy: false,
        address: '0xA396EA72521678e9A1670cA87E81E5B8815d9352',
      ...
      AaveV3Withdraw: {
        name: 'AaveV3Withdraw',
        deploy: false,
        address: '0xc726938F1220855721bF19E858d3f9091f060D7a',
        ...
        history: [
          ...
          '0x7c7CC7C433bfb1939151151347E0206BbBE698B0'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3WithdrawAuto: {
      ...
      AaveV3Deposit: {
        name: 'AaveV3Deposit',
        deploy: false,
        address: '0xFfA2BEc402f1baDED49Cfd8AF229aEb812Dc4e5b',
      ...
      AaveV3Payback: {
        name: 'AaveV3Payback',
        deploy: false,
        address: '0xEabeF16E91311dB517dB0C261Cd254e32BA8ba99',
        ...
        history: [
          ...
          '0xA227a60F2b2CB426A838115b15738B39ed051D7F'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3SetEMode: {
        name: 'AaveV3SetEMode',
        deploy: false,
        address: '0xD0331Ffc014b45f70d607105dCbF698798dBDCdD',
      ...
      SparkWithdrawAuto: {
        ...
        history: [ '', '0xE018AeA83728a037D8B6f76cCA0E8331cDAb937a' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      SparkDeposit: {
        name: 'SparkDeposit',
      ...
      MorphoBlueWithdrawAuto: {
        name: 'MorphoBlueWithdrawAuto',
        deploy: false,
        address: '0x2002dd2F14a3aADB0772Dbb532e43DF8c7ccCd5B',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.morphoblue.WITHDRAW_AUTO,
        history: [
          '0x0000000000000000000000000000000000000000',
          '0x0000000000000000000000000000000000000000'
        ],
      ...
      MorphoBluePayback: {
        ...
        deploy: false,
        address: '0x3ee228FE8A908C36152AE295E0D3a9CdF47Ac475',
