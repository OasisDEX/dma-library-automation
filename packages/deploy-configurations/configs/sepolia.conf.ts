  ...
  mpa: {
    core: {
      ...
      OperationExecutor: {
        ...
        serviceRegistryName: 'OperationExecutor_5',
        history: [],
      ...
      OperationStorage: {
        ...
        deploy: false,
        address: '',
        serviceRegistryName: 'OperationStorage_5',
        history: [],
      ...
      OperationsRegistry: {
        ...
        deploy: false,
        address: '',
        serviceRegistryName: 'OperationsRegistry_5',
        history: [],
        constructorArgs: [],
      },
      DSProxyFactory: {
    ...
    actions: {
      ...
      SwapAction: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'SwapAction_8',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      TakeFlashloan: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'TakeFlashloan_6',
        history: [],
      ...
      SetApproval: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'SetApproval_6',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      PullToken: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'PullToken_7',
        history: [],
        constructorArgs: [],
      },
      SendToken: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'SendToken_7',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      WrapEth: {
      ...
      UnwrapEth: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'UnwrapEth_6',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      ReturnFunds: {
        ...
        deploy: true,
        address: '',
        serviceRegistryName: 'ReturnFunds_6',
        history: [],
        constructorArgs: [],
      },
      AaveBorrow: {
      ...
      AaveV3Borrow: {
        ...
        serviceRegistryName: 'AaveV3Borrow_5',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AaveV3Withdraw: {
        ...
        deploy: false,
        address: '',
        serviceRegistryName: 'AaveV3Withdraw_5',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AaveV3Deposit: {
        ...
        serviceRegistryName: 'AaveV3Deposit_5',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AaveV3Payback: {
        ...
        serviceRegistryName: 'AaveV3Payback_5',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AaveV3SetEMode: {
        ...
        serviceRegistryName: 'AaveV3SetEMode_5',
        history: [],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AjnaDepositBorrow: {
